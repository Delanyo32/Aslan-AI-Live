...
**Run in terminal:**
```bash
claude mcp add --transport http exa https://mcp.exa.ai/mcp?exaApiKey=7df8366d-4eba-4971-b463-4478d2d76f70
```
...
```
https://mcp.exa.ai/mcp?exaApiKey=7df8366d-4eba-4971-b463-4478d2d76f70&tools=web_search_exa,get_code_context_exa,people_search_exa
```

Enable all tools:
```
https://mcp.exa.ai/mcp?exaApiKey=7df8366d-4eba-4971-b463-4478d2d76f70&tools=web_search_exa,web_search_advanced_exa,get_code_context_exa,crawling_exa,company_research_exa,people_search_exa,deep_researcher_start,deep_researcher_check
```

**Your API key:** `7df8366d-4eba-4971-b463-4478d2d76f70`
...
const results = await exa.searchAndContents("OpenAI announcements", {
  "type": "auto",
  "numResults": 10,
  "category": "news",
  "highlights": {
...
Use `category: "news"` to search for news content.
...
**Tips:**
- Avoid date filters unless explicitly required
